...
// Fungsi untuk mengecek apakah alamat URL sudah benar
function isCorrectURL(url) {
    var correctURL = 'https://www.samuelpasaribu.com';
  ...
  function redirectToPage() {
    ...
    if (!isCorrectURL(currentURL)) {
      window.location.href = 'https://www.samuelpasaribu.com';
    }
  }
  
  // Cek alamat URL saat halaman dimuat
  redirectToPage();
